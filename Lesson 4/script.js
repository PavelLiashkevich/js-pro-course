...
//	sayHello() {
//		alert(`Hello, ${this.firstName}! My name is ${this.firstName}`);
//	}
//}
//worker.sayHello();
 ...
 */
function Worker (name, secondName, rate, days, getSalary) {
	this.name = name;
...
let newWorkerOne = new Worker('Paul', 'Smith', 20, 40);
let newWorkerTwo = new Worker('Steve', 'Jobs', 35, 30);
